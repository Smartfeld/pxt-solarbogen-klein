...
sonnenbogen.init(DigitalPin.P0, 30,255)
...
basic.forever(function () {
    ...
    sonnenbogen.moveSunAutomatically(10)
    basic.pause(1000)
    sonnenbogen.setBrightnessOfTheSun(200)
    basic.pause(1000)
    sonnenbogen.setBrightnessOfTheSun(150)
    basic.pause(1000)
    ...
    basic.pause(1000)
    sonnenbogen.setBrightnessOfTheSun(0)
    basic.pause(1000)
    sonnenbogen.setBrightnessOfTheSun(50)
    basic.pause(1000)
    sonnenbogen.setBrightnessOfTheSun(100)
    ...
    sonnenbogen.setBrightnessOfTheSun(150)
    basic.pause(1000)
    sonnenbogen.setBrightnessOfTheSun(255)
    basic.pause(1000)
})
